                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-primary text-white-all">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i> Settings
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div class="pricing pricing-highlight">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6">
                                        <div class="progress blue">
                                            ...
                                            <div class="progress-value" id="pourcent">{{$score_recent}}%</div>
                                        </div>
                                    </div>
                            ...
                            <form class="p-3" action="{{route('plagiat.settings.store')}}" method="post">
                                @csrf
                                @method('POST')
                                ...
                                <div class="pricing-cta">
                                    <button type="submit" class=" form-control btn btn-primary" onclick="getValue()"
                                            style="font-size: 30px !important;  ">Valider
                                    </button>
                                </div>
                            </form>
                            <script>
