                                        ...
                                        <div class="col-sm-12 col-md-12 ml-3">
                                            ...
                                            @elseif ($path1 = Session::get('path'))
                                                <embed src="{{ asset("storage/$path1")}}" type="application/pdf"
                                                       width="750" height="550" class="ml-5">
                                            @else
                                                <textarea class="summernote "
                            ...
                            <form action="{{route('plagiat.en_ligne.store')}}" method="post">
                                ...
                                <div class="d-flex justify-content-center align-items-center py-5">
                                    <button type="submit" class="btn btn-icon icon-left btn-primary"><i
                                            class="fas fa-arrow-right"></i> Lancer
                                    </button>
                                </div>
                            </form>
                        </section>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="table-1">
                                                    ...
                                                    <tbody>
                                                    @if ($resultats = Session::get('resultats') and $scores = Session::get('scores') and $seuil = Session::get('seuil') )
                                                            ...
                                                            <tr>
                                                                ...
                                                                @if($scores[$key]+ $resultats->percentPlagiarism < $seuil)
                                                                    <td class="align-middle text-success">
                                                                        {{round($scores[$key]+ $resultats->percentPlagiarism, 2)}}
                                                                        %
                                                                    </td>
                                                                @else
